...
export default function Lsbpro( { sliding } ) {
    useEffect( () => {
        window.scrollTo( 0, 0 )
    }
        , [] )
        ...
        <div>
            ...
            <div className='lsbprortcont'>
                <p className='lsbprotxtcont'>
                    ...
                    <span>
                        <strong>Busbar and Insulation:</strong><br />
                        Lectrobars are fabricated from high strength pure
                        electrolytic copper with suitable cross section tin coated at
                        contacts ( conductivity better than 99.5%). Tin coating
            ...
            <div className='lsbproltcont'>
                <p className='lsbprotxtcont'>
                    ...
                    <span>
                        ...
                        configuration. The non-ventilated housing design
                        excludes potential points of penetration by moisture
                        and dust.
                        ...
                        throughout the entire busduct length for both feeder
