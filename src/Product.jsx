  ...
  return (
    <div>
      ...
      <div className="productltcont">
        <p className="producttxtcont">
          <a href={currentProduct.link} target="_blank">
            <img src={currentProduct.img1} alt="" className="productimg" />
          </a>
      ...
      <div className="productrtcont">
        <p className="producttxtcont">
          <img src={currentProduct.img2} alt="" className="productimg" />
          {currentProduct.description2}
        </p>
      </div>
      <div className="productltcont">
        <p className="producttxtcont">
          <img src={currentProduct.img3} alt="" className="productimg" />
