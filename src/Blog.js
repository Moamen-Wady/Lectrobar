...
export default memo( function Blog( { sliding } ) {
    ...
    var [ intro1, setIntro1 ] = useState( 0 )
    var [ intro2, setIntro2 ] = useState( 0 )
    var [ intro3, setIntro3 ] = useState( 0 )
    var [ intro4, setIntro4 ] = useState( 0 )
    ...
    useEffect(
        () => {
            ...
            var bev1 = document.getElementById( 'bev1' )
            var blogcircle1 = document.getElementById( 'blogcircle1' )
            var blogcirclecont1 = document.getElementById( 'blogcirclecont1' )
